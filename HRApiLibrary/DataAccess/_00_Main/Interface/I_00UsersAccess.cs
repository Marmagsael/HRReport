...
namespace HRApiLibrary.DataAccess._00_Main.Interface
{
    public interface I_00UsersAccess
    {
        ...
        Task<List<UsersModel?>> _02(string? search, string? pisschema, string? mainschema = "Main", string? connName = "MySqlConn");
        Task<UsersModel?> _02LoginName_ForUserAccess(string? loginName, string? pisschema, string? mainschema = "Main", string? connName = "MySqlConn");
