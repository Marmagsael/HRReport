...
public class AttreqdtlDataAccess : IAttreqdtlDataAccess
{
    ...
    {
        string sql = $@"Insert into {schema}.Attreqdtl (AttReqHdrId, DStart, DEnd, TotHrs, AttReqTypeId) values (@AttReqHdrId, @DStart, @DEnd, @TotHrs, @AttReqTypeId)";
    ...
    public async Task<AttreqdtlModel?> _04(int id, string schema, string conn)
    {
...
public interface IAttreqdtlDataAccess
{
    ...
    Task<AttreqdtlModel?> _04(int id, string schema, string conn);
}
